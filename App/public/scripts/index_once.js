...
//   const deleteButtonElement = document.getElementById('delete-button');
  ...
  const setupUI = (user) => {
    if (user) {
      ...
      var i = 0;
      firebase.database().ref('UsersData/' + uid.toString() + '/config/line').orderByKey().once('child_added', snapshot =>{
      ...
      var ii = 0;
      firebase.database().ref('UsersData/' + uid.toString() + '/config/time').orderByKey().once('child_added', snapshot =>{
        var jsonData = snapshot.toJSON(); // example: {temperature: 25.02, humidity: 50.20, flag: 1008.48, timestamp:1641317355}
      ...
      firebase.database().ref('UsersData/' + uid.toString() + '/config/everyhour').orderByKey().once('child_added', snapshot =>{
        var jsonData = snapshot.toJSON(); // example: {temperature: 25.02, humidity: 50.20, flag: 1008.48, timestamp:1641317355}
      ...
      var iii = 0;
      firebase.database().ref('UsersData/' + uid.toString() + '/config/gps').orderByKey().once('child_added', snapshot =>{
        var jsonData = snapshot.toJSON(); // example: {temperature: 25.02, humidity: 50.20, flag: 1008.48, timestamp:1641317355}
        console.log(jsonData)
      ...
      var iiii = 0;
      firebase.database().ref('UsersData/' + uid.toString() + '/config/adjusterror').orderByKey().once('child_added', snapshot =>{
        var jsonData = snapshot.toJSON(); // example: {temperature: 25.02, humidity: 50.20, flag: 1008.48, timestamp:1641317355}
        console.log(jsonData)
      ...
      firebase.database().ref('UsersData/' + uid.toString() + '/config/unit').orderByKey().once('child_added', snapshot =>{
        var jsonData = snapshot.toJSON(); // example: {temperature: 25.02, humidity: 50.20, flag: 1008.48, timestamp:1641317355}
        console.log(jsonData)
      ...
      chartRef.once('value', snapshot =>{
        ...
        dbRef.orderByKey().limitToLast(chartRange).once('child_added', snapshot =>{
          var jsonData = snapshot.toJSON(); // example: {temperature: 25.02, humidity: 50.20, flag: 1008.48, timestamp:1641317355}
      ...
      dbRef.orderByKey().limitToLast(1).once('child_added', snapshot =>{
        var jsonData = snapshot.toJSON(); // example: {temperature: 25.02, humidity: 50.20, flag: 1008.48, timestamp:1641317355}
        var temperature = jsonData.temperature;
        var humidity = jsonData.humidity;
        var flag = jsonData.flag;
    ...
    //   });
      ...
      function createTable(){
        ...
        var firstRun = true;
        dbRef.orderByKey().limitToLast(100).once('child_added', function(snapshot) {
          if (snapshot.exists()) {
